...
class ReallySimpleNoteStorage {
    ...
    func addNoteXXX(passTagId:String, passPhotoRef:String, noteTitle:String, noteText:String) {
...
//        ReallySimpleNoteCoreDataHelper.createNoteInParse(
...
//    }
    ...
    func changeNote(noteTitle: String, noteText: String) {
        print("CHANGENOTE")
    }
