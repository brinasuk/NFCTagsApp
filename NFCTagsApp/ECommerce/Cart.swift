...
final class Cart {
    ...
    static let cartUpdatedNotificationName = "com.hillsidesoftware.ios.cart.updated.notification"
...
//    func updateQuantity(item: CartModel, value: Int) -> Bool {
//        //If we are adding an item
//        var objectId:String = item.tagObjectId
//
...
//    }
    ...
    //ADDED BY ALEX
    func findObjectIdInCart(item: CartModel) -> String {
        let objectId:String = item.tagObjectId
        return objectId
    }
